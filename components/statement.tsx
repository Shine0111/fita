export function Statement() {
  return (
    <section className="relative flex min-h-[50svh] flex-col justify-between overflow-hidden bg-[#0c0c0e] p-6 lg:min-h-0 lg:p-10">
      ...
      <div className="my-auto py-8">
        <h2 className="headline-tight max-w-2xl font-[family-name:var(--font-syne)] text-[clamp(3rem,6.2vw,6.4rem)] font-extrabold uppercase text-zinc-100">
          I edit{" "}
          <span className="text-zinc-500">stories</span> that move.
        </h2>
